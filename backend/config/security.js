...
module.exports.security = {
  ...
  cors: {
    ...
    allowRequestMethods: 'GET,PUT,POST,OPTIONS,HEAD,DELETE,PATCH',
    allowRequestHeaders:
      'Origin, X-Requested-With, Content-Type, Accept, Authorization, x-auth, Accept-Language, access-control-allow-origin,lang',
  },
